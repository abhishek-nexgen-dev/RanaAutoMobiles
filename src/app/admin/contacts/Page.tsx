        ...
        <Table className="w-full  text-white bg-[#232323] rounded-xl overflow-hidden shadow-lg">
          ...
          <TableHeader>
            <TableRow className="bg-[#181818]">
              ...
              <TableHead className="text-[#f472b6] text-base hidden md:block">
                Phone
              </TableHead>
              <TableHead className="text-[#a78bfa] text-base">Date</TableHead>
              <TableHead className="text-right text-[#FFB900] text-base">
                Action
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {contacts.map((contact, idx) => (
              ...
              >
                ...
                <TableCell className="text-[#60a5fa]">
                  {contact.email}
                </TableCell>
                <TableCell className="text-[#f472b6] hidden md:block">
                  {contact.phone}
                </TableCell>
