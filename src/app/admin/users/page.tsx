  ...
  return (
    <div className='bg-black w-[84vw] min-h-screen text-white flex items-start justify-end p-[3vw]'>
      <Table className='w-full text-white bg-[#232323] rounded-xl overflow-hidden shadow-lg'>
        <TableCaption className="text-[#FFB900] font-semibold">A list of all registered users.</TableCaption>
        <TableHeader>
          <TableRow className="bg-[#181818] hover:bg-[#181616]">
            <TableHead className="w-[80px] text-[#FFB900] text-base">S.no</TableHead>
            <TableHead className="text-[#10b981] text-base">User Name</TableHead>
            <TableHead className="text-[#60a5fa] text-base">User Email</TableHead>
            <TableHead className="text-right text-[#f472b6] text-base">User Phone Number</TableHead>
            <TableHead className="text-right text-[#facc15] text-base">Action</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {users.map((user, idx) => (
            ...
            >
              ...
              <TableCell className="text-right text-[#f472b6]">{user.phone}</TableCell>
