...
export function SignUpForm() {
  return (
    <div className="Signup_Form w-[80%] h-[70%] flex items-center justify-center">
      <Card className="bg-[#1a1a1a] w-full p-0 m-0 flex flex-col border-[1px] border-[#393939] rounded-lg">
        <CardHeader className="w-full p-0">
          <CardTitle className="bg-[#161313] text-center w-full py-[0.8rem] text-[#10b981] font-semibold flex items-center justify-center rounded-tr-2xl rounded-tl-2xl">
            Sign Up
          </CardTitle>
        </CardHeader>
        ...
        <CardFooter className="flex flex-col gap-4">
          <Button
            type="submit"
            className="w-full bg-[#10b981] hover:bg-[#64b49a]"
          >
            Sign Up
          </Button>
          <Button
            variant="outline"
            className="w-full mb-[1.8rem] bg-[#6366f1] hover:bg-[#6163b4] text-white lg:mb-[13vh]"
            asChild
          >
