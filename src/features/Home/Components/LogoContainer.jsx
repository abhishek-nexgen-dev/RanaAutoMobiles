  ...
  return (
    <div className='Logo_Container h-[10vh] w-screen '>
      <div className="w-full h-full relative  overflow-hidden" >
       ...
       <div className="logo w-[200%] h-full flex items-center justify-start gap-2 " ref={LogoRef}>

      
       {
          LogoContainer_Array.map((item, index) => {
            return (
              <div className="Image_Container h-full w-fit transition-all overflow-hidden" key={index}>
                <img
                  src={item.src}
                  alt={item.alt}
                  width={item.width}
